...
建议在本地运行 `http://localhost:5173` 后截取以下四张图。它们分别对应项目的核心能力：
...
截图目录的保存规范见 [`docs/screenshots/README.md`](docs/screenshots/README.md)。对话中的截图附件不会自动写入 Git 工作区，需要先保存为上述文件，再在这里补充图片链接。
